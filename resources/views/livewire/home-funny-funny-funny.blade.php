							...
							<div id="cart" class=" btn-group btn-shopping-cart">
								<a data-loading-text="Loading..." class="btn-group top_cart dropdown-toggle" data-toggle="dropdown">
									<div class="shopcart">
										...
										<span>My Cart</span>
										@if (Cart::count() > 0)
											<span class="total-shopping-cart cart-total-full">	{{ Cart::count() }}</span>
										@endif
									</div>
								</a>
								<ul class="tab-content content dropdown-menu pull-right shoppingcart-box" role="menu">							
									...
									<li>
										<div>
											...
											<p class="text-center"> <a class="btn view-cart" href="/cart"><i class="fa fa-shopping-cart"></i>View Cart</a>&nbsp;&nbsp;&nbsp; <a class="btn btn-mega checkout-cart" href="checkout.html"><i class="fa fa-share"></i>Checkout</a> </p>
										</div>
									</li>
								</ul>
							</div>
                        ...
                        <div class="spcat-wrap ">
                                    ...
                                    <div class="spcat-tabs-wrap">
                                        ...
                                        <ul class="spcat-tabs cf">
                                            @foreach ($hCategories as $key=>$hCategory)
                                                <li class="spcat-tab {{ $key==0 ? 'active' : ''}}" data-active-content=".items-category-{{ $hCategory->id }}" data-field_order="sales">
                            ...
                            <div class="main-right">									
                                <div class="spcat-items-container products-list grid show-pre show-row">
                                    ...
                                    @foreach ($hCategories as $homeCat)

                                    <div class="spcat-items spcat-items-loaded items-category-{{ $homeCat->id }} product-layout spcat-items-selected" data-total="9">
                                        <div class="spcat-items-inner spcat00-4 spcat01-4 spcat02-3 spcat03-2 spcat04-1 flip">
                                           

                                                
                                                    @foreach ($homeCat->products as $hProduct)
                                                          ...
                                                          <div class="ltabs-item ">
                                                            <div class="item-inner product-thumb product-item-container transition ">
                                                                <div class="left-block">
                                                                    <div class="product-image-container">
                                                                        <div class="image">
                                                                            <a class="lt-image" href="{{ route('product.details', $hProduct->slug) }}" target="_self" title="{{ $hProduct->name }}">
                                                                                <img  src="{{ asset('assets/image/demo/shop/product/fo4.jpg') }}" alt="img" title="Duidem rerum facilis" class="img-1 img-responsive" />
                                                                                <img  src="{{ asset('assets/image/demo/shop/product/fo4.jpg') }}" alt="img" title="Duidem rerum facilis" class="img-2 img-responsive" />
                                                                            </a>
                                                                        </div>
                                                                ...
                                                                <div class="right-block">
                                                                    <div class="caption">
                                                                        ...
                                                                        <h4>
                                                                            <a href="{{ route('product.details', $hProduct->slug) }}" title="{{ $hProduct->name }}" target="_self">
                                                                            {{ $hProduct->name }}							</a>
                                                                        </h4>				
                                                                        <p class="price">
                                                                            <span class="price-new">{{ $hProduct->regular_price }}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div class="button-group">
