          ...
          <div id="content" class="col-sm-12">
            ...
            <div class="row">
              <div class="col-sm-4">
                  ...
                  <div class="panel-heading">
                    ...
                    <div class="panel-body">
                          <fieldset id="account">
                            ...
                            <div class="form-group">
                              <label for="input-payment-fax" class="control-label">Speccial Instruction</label>
                ...
                <div class="checkbox">
                  <label>
                    <input type="checkbox"  value="1" name="shipping_address" wire:model="shippingToDifferent">
